...
public struct CalendarViewControllers {

  public static var calendarStoryboard: UIStoryboard {
    UIStoryboard(name: "Calendar", bundle: Bundle.init(for: FullCalendars.self))
  }
...
struct CalendarNibs {
  ...
  static var dateHeaderView: DateHeaderView {
    let bundle = Bundle.init(for: DateHeaderView.self)
