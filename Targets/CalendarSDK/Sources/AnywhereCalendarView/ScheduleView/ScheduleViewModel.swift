...
public protocol ScheduleVMProtocol: AnyObject {
...
public class ScheduleViewModel: ScheduleVMProtocol {

  var calendarDatasource: FullCalendarDataSource
  public var viewConfiguration: ScheduleViewConfiguration
  ...
  public var canShowPlaceHolder: Bool {
    return calendarDatasource.numberOfCalendarItems == 0
  }

  public init(calendarDatasource: FullCalendarDataSource, withConfig config: ScheduleViewConfiguration = .init()) {
  ...
  public func getDate(at section: Int) -> Date? {
  ...
  public func getCalendarItem(at indexPath: IndexPath) -> CalendarItem? {
  ...
  public func getSectionName(at section: Int) -> String {
    return getDate(at: section)?.toString() ?? "" //need to verify this
  }

  public func getCalendarItems(at section: Int) -> [CalendarItem] {
    guard section < calendarDatasource.activeDates.count else {
      return []
    }
  ...
  public func getIndexPath(forDate date: Date, shouldGetLastRow: Bool) -> IndexPath? {
  ...
  public func canShowPlaceholder(forSection section: Int) -> Bool {
