...
public extension CalendarSDK {
    static func getWeeklyCalendar(withConfiguration config: CalendarViewConfiguration, dataProvider: AnywhereCalendarDataProvider, actionDelegate: AnyCalActionDelegate?) -> CalendarView {
    ...
    static func getThreeDayCalendar(withConfiguration config: CalendarViewConfiguration, dataProvider: AnywhereCalendarDataProvider, actionDelegate: AnyCalActionDelegate?) -> CalendarView {
        let baseDataProvider = CalendarBaseDataProvider(withAnyCalDataProvider: dataProvider)
        guard let baseActionDelegate = actionDelegate else {
    ...
    static func getDailyCalendar(withConfiguration config: CalendarViewConfiguration, dataProvider: AnywhereCalendarDataProvider, actionDelegate: AnyCalActionDelegate?) -> CalendarView {
        let baseDataProvider = CalendarBaseDataProvider(withAnyCalDataProvider: dataProvider)
        guard let baseActionDelegate = actionDelegate else {
    ...
    static func getCustomCalendarView(forNumberOfDays numberOfDays: Int, withConfiguration config: CalendarViewConfiguration, dataProvider: AnywhereCalendarDataProvider, actionDelegate: AnyCalActionDelegate?) -> CalendarView {
        let baseDataProvider = CalendarBaseDataProvider(withAnyCalDataProvider: dataProvider)
        guard let baseActionDelegate = actionDelegate else {
    ...
    static func getScheduleView(withConfig scheduleConfig: ScheduleViewConfiguration = ScheduleViewConfiguration(), placeholderView: ActionableView? = nil, dimension: ScheduleViewDimensions = ScheduleViewDimensions(), dataProvider: AnywhereCalendarDataProvider, actionDelegate: AnyCalActionDelegate?) -> CalendarView {
