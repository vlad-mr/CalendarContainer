...
public struct AnywherePickerTheme: DatePickerTheme {
    ...
    public var todayColor = UIColor(red: 232 / 255, green: 244 / 255, blue: 254 / 255, alpha: 1)
    public var weekdayPrimaryColor: UIColor = .lightGray

    public var selectedDateTintColor = UIColor(red: 0.113, green: 0.564, blue: 0.960, alpha: 1)
