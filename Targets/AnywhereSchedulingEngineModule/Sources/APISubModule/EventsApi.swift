...
extension EventsApi {
    func getEventModel() -> EventModel {
        ...
        let defaultEvent = EventModel(id: UUID().uuidString, calendar: UUID().uuidString, merchant: accountId, brand: .Anytime, provider: [], service: [], consumer: [], resource: [], startTime: 0, endTime: 0, maxSeats: 0, bookingId: nil, location: nil, createdBy: appUserId, createdTime: 123, updatedTime: 1233)
