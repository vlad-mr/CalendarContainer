...
public extension CalendarTheme {
    ...
    static var Light: Self {
        .init(backgroundColor: .white,
              ...
              hourSeparatorColor: .grey100,
              daySeparatorColor: .grey100,
              timeHeaderBackgroundColor: .white,
              timeheaderTextColor: UIColor(white: 100 / 255, alpha: 1.0),
              dateHeaderBackgroundColor: .white,
              currentDateHighlightColor: UIColor.blue700,
              currentDateText: .white,
              defaultDateText: .black,
              weekdayShortName: UIColor(white: 153/255, alpha: 1.0),
              currentTimelineColor: .red200,
              selectorColor: .blue,
              heading: .grey700,
              subHeading: UIColor(red: 20/255, green: 20/255, blue: 20/255, alpha: 1),
              dayOffColor: .grey300)
    }
